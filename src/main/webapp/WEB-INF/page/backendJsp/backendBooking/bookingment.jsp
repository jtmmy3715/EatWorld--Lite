				...
				<div class="row">
					<div class="col-lg-12">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">
									 <span><a href="#" data-toggle="button" data-placement="top" title="新增"> <i class="fa-solid fa-plus" onclick="new_data()"></i></a> 
									訂位管理
									</span>

								</h4>
								<h4 class="card-title">
								<span style="text-align:center;display:block;">管理員</span>
								</h4>
												...
												<tr>
													...
													<td align="center"><span> <a href="#"
															...
															title="刪除"> <i class="fa fa-close color-danger"
																onclick="delete_data('${booking.booking_id}');"
																id="delete_data"></i></a>
													</span></td>
