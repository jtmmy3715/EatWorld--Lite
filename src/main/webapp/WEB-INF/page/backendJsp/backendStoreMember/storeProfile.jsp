...
<body>
	...
	<div id="main-wrapper">
		...
		<div class="content-body" style="min-height: 884px;">
			...
			<div class="row page-titles mx-0">
				...
				<div class="col p-md-0">
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="javascript:void(0)">廠商後台管理</a></li>

						<li class="breadcrumb-item active"><a
							href="javascript:void(0)">修改商家資料</a></li>
						...
						<div class="card">
							<div class="card-body">
								<div class="form-validation">
									...
									<form:form class="form-valide" action="saveStoreUpdate"
										method="post" id="StoreForm" enctype="multipart/form-data"
										modelAttribute="store">

										<form:hidden path="id" name="id" />
										<form:hidden path="addDate" name="addDate" />
										<form:hidden path="sUsername" name="sUsername" />
										<form:hidden path="sLogo" name="sLogo" />
										<form:hidden path="sPwd" name="sPwd" />
										<form:hidden path="sEmail" name="sEmail" />
										
										<div class="form-group row" id="bgImg">
											<label path="sName" class="col-lg-4 col-form-label"
												for="sName"> <img id="sourceImage"
												src="<%=request.getContextPath()%>/photo/${store.sLogo}" width="130" height="130"/>
											</label>
											<div class="col-lg-6" style="margin-top:90px;">
												<input type="file" class="form-control input-rounded"
													id="inputImageFile" name="sfiles" />
											</div>
										</div>
            ...
            <span class="text-danger">*</span>
											...
											<div class="col-lg-6">
												<form:input path="sName" type="text" class="form-control input-rounded"
													id="sName" name="sName" />
											</div>
										</div>
            ...
            <span class="text-danger">*</span>
											...
											<div class="col-lg-6">
												<form:input path="sPhone" type="text" class="form-control input-rounded"
            ...
            <span class="text-danger">*</span>
											...
											<div class="col-lg-6">
												<form:input path="sIntroduction" type="text"
													class="form-control input-rounded" id="sIntroduction"
													name="sIntroduction" />
											</div>
										</div>
            ...
            <span class="text-danger">*</span>
											...
											<div class="col-lg-6">
												<form:input path="sAddress" type="text" class="form-control input-rounded"
            ...
            <span class="text-danger">*</span>
											...
											<div class="col-lg-6">
												<form:input path="openTime" type="time" class="form-control input-rounded"
            ...
            <span class="text-danger">*</span>
											...
											<div class="col-lg-6">
												<form:input path="endTime" type="time" class="form-control input-rounded"
        ...
        <div class="col-lg-6">
            <form:select path="sBooking" type="text" class="form-control input-rounded" id="sBooking" name="sBooking">
                <form:option value="0">開啟</form:option>
                <form:option value="1">關閉</form:option>
            </form:select>
        </div>
    </div>
...
<div class="col-lg-6">
    <form:select path="storeclassification.cId" type="text" class="form-control input-rounded" id="sCategory"
        name="sCategory">
		...
		<script>
			function back() {
				window.location.href = "<%=request.getContextPath()%>/backendStore";
			}
		</script>
		<script>
