							...
							<div class="tab-content">
								<div id="lg1" class="tab-pane active">
									<div class="login-form-container">
										...
										<img src="<%=request.getContextPath()%>/photo/checked.png" width=200 height=200;>
											<div style="margin-bottom:50px;"></div>
											<h3><strong></strong>驗證成功，請重新登入</strong></h3>
										</div>
										<br>
										<center>
											<button type="button" class="btn btn-warning">
												<a href="http://localhost:8080/EatWorld/logout">重新登入</a>
											</button>
										</center>
									</div>
								</div>
