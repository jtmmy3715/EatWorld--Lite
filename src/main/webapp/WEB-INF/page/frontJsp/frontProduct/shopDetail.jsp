								...
								<div class="blog-wrap mb-30">
									<div class="blog-img mb-15">
										<a href="blog-details.html"><img alt=""
											src="${pageContext.request.contextPath}/assets/images/blog/blog-3.jpg"></a>
									</div>
								</div>
							</div>
					<div class="col-lg-6 col-md-6">
									...
									<div class="review-wrapper">
										<div class="single-review">
											<div class="review-img">
												<img src="${pageContext.request.contextPath}/assets/images/product-details/client-1.jpg" alt="">
											</div>
										...
										<div class="single-review">
											<div class="review-img">
												<img src="${pageContext.request.contextPath}/assets/images/product-details/client-2.jpg" alt="">
											</div>
											<div class="review-content">
												<p>âIn convallis nulla et magna congue convallis.
													Donec eu nunc vel justo maximus posuere. Sed viverra nunc
										...
										<div class="single-review">
											<div class="review-img">
												<img src="${pageContext.request.contextPath}/assets/images/product-details/client-3.jpg" alt="">
											</div>
											<div class="review-content">
												<p>âIn convallis nulla et magna congue convallis.
													Donec eu nunc vel justo maximus posuere. Sed viverra nunc
			...
			<div class="container">
				...
				<div class="product-slider-active owl-carousel">
					<div class="product-wrap product-border-1">
						<div class="product-img">
							<a href="product-details.html"><img
								src="${pageContext.request.contextPath}/assets/images/product/hm1-pro-1.jpg" alt="product"></a>
					...
					<div class="product-wrap product-border-1">
						<div class="product-img">
							<a href="product-details.html"><img
								src="${pageContext.request.contextPath}/assets/images/product/hm1-pro-2.jpg" alt="product"></a><span
					...
					<div class="product-wrap product-border-1">
						<div class="product-img">
							<a href="product-details.html"><img
								src="${pageContext.request.contextPath}/assets/images/product/hm1-pro-3.jpg" alt="product"></a>
							<div class="product-action">
								<a data-toggle="modal" data-target="#exampleModal"
									title="Quick View" href="#"><i class="la la-plus"></i></a><a
									title="Add To Cart" href="#"><i class="la la-shopping-cart"></i></a><a
					...
					<div class="product-wrap product-border-1">
						<div class="product-img">
							<a href="product-details.html"><img
								src="${pageContext.request.contextPath}/assets/images/product/hm1-pro-4.jpg" alt="product"></a><span
								class="product-badge">Sell</span>
							<div class="product-action">
								<a data-toggle="modal" data-target="#exampleModal"
									title="Quick View" href="#"><i class="la la-plus"></i></a><a
					...
					<div class="product-wrap product-border-1">
						<div class="product-img">
							<a href="product-details.html"><img
								src="${pageContext.request.contextPath}/assets/images/product/hm1-pro-5.jpg" alt="product"></a>
							<div class="product-action">
								<a data-toggle="modal" data-target="#exampleModal"
									title="Quick View" href="#"><i class="la la-plus"></i></a><a
									title="Add To Cart" href="#"><i class="la la-shopping-cart"></i></a><a
