			...
			<div class="container">
				<div class="breadcrumb-content text-center">
					...
					<ul>
						...
						<li class="active">shop grid full wide</li>
					</ul>
				</div>
			</div>
		</div>
									...
									<div class="row">
											...
											<div class="product-wrap product-border-1 mb-30">
												...
												<div
													...
													<div class="product-price">
														<span>Â£210.00</span><span class="old">Â£230.00</span>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12">
											<div class="product-wrap product-border-1 mb-30">
												<div class="product-img">
													<a href="product-details.html"><img
														src="assets/images/product/hm1-pro-6.jpg" alt="product"></a><span
														class="product-badge">-30%</span>
													<div class="product-action">
														<a data-toggle="modal" data-target="#exampleModal"
															title="Quick View" href="#"><i class="la la-plus"></i></a><a
										...
										<div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12">
											<div class="product-wrap product-border-1 mb-30">
												<div class="product-img">
													<a href="product-details.html"><img
														src="assets/images/product/hm1-pro-8.jpg" alt="product"></a><span
										...
										<div class="row">
											...
											<div class="col-xl-8 col-lg-7 col-md-7 col-sm-6">
												<div class="shop-list-content">
													...
													<div class="product-list-price">
														<span>$ 120.00</span><span class="old">$ 250.00</span>
													</div>
													<p>Lorem ipsum dolor sit amet, consectetur adipisicing
														elit, sed do eiusmod tempor incididunt ut labore et dolore
														magna aliqua. Ut enim ad minim veniam, quis nostrud
