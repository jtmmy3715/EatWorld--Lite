			...
			<!-- body -->
				<div class="row flex-row-reverse">
					<div class="col-lg-9">
						...
						<!--今日優惠活動開始-->
						<h3 style=color:indianred;font-weight:bolder>&emsp;今日適用優惠活動:</h3><br>
						...
						<div class="sidebar-style">
							<div class="sidebar-widget">
								...
								<div class="pro-sidebar-search mb-50 mt-25">
									<form class="pro-sidebar-search-form" action="frontSearch" method="post">
										<input type="text" name="searchName" placeholder="請輸入查詢內容...">
										<button>
							...
							<div class="sidebar-widget">
								<hr><hr>
								<h5 style=color:red;text-align:center>用Line就可以查詢今日優惠!</h5>							
								<h4 class="pro-sidebar-title" style=text-align:center>"@011dykva" 加好友輸入<br> "優惠活動"即可查詢目前打折商品</h4>
							</div>
