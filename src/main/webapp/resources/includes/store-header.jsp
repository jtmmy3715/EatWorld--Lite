                    ...
                    <ul class="clearfix">
                        ...
                        <li class="icons dropdown">
                            <div class="user-img c-pointer position-relative"   data-toggle="dropdown">
                                <img src="${pageContext.request.contextPath}/photo/${user.sLogo}" height="40" width="40" alt="">
                            </div>
                            <div class="drop-down dropdown-profile   dropdown-menu">
                                <div class="dropdown-content-body">
                                    <ul>
                                        <li>
                                            <a href="${pageContext.request.contextPath}/store/storeProfile"><i class="icon-user"></i> <span>商家資料</span></a>
                                        </li>
                                        <li><a href="${pageContext.request.contextPath}/logout"><i class="icon-key"></i> <span>登出</span></a></li>
                                    </ul>
                                </div>
                            </div>
                        </li>
