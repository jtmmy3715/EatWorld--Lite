...
//			String s="./src/main/resources/payment_conf.xml";
//			System.out.println(s+"位址:"+classLoader.getResource(s));
//			String configPath = URLDecoder.decode(classLoader.getResource("./src/main/resources/payment_conf.xml").getPath(), "UTF-8");
